...
# prompt = """SUmmarize this given problem is simple words by telling me whats hapeening?
...
# word = print(word.replace("Par","Jag"))

# print(id(word))

# word = "cat cat cat"

# print(word.replace('cat', 'dog'))
